            ...
            <section className="aboutus">
                <div className="container">
                    ...
                    <MemberMemory
                        nick="TREM_27"
                        image={TREM_27}
                        text="Začal jsem stavět asi před čtyřmi lety, kdy jsem už tehdy měl nějaké povědomí o QPlayi a celkově jsem byl zaujatý jejich stavbami. Od začátku jsem se snažil od nich něco sem tam pochytit a přiučit, i když to bylo jen z toho, co jsem viděl na serveru. A asi po roce jsem se rozhodl, že bych to chtěl zkusit a začít dál rozvíjet své builderské schopnosti. A tak jsem dne 4.2. 2021, po měsíc trvajícím náboru, plný nadšení a očekávání, byl přijat Jendou do B-teamu. Postupem roku jsem se za pomoci B-teamu toho hodně naučil a pochytil spoustu nových věcí a zkušeností. QPlay měl vždy svůj unikátní styl staveb a v tom byl jedinečný. Později jsme i, jako jediní v česku v té době, začali experimentovat se zahraničními styly a zapojovali je do staveb. A právě toto experimentování mně, a nejen mně, dalo motivaci zkusit se posunout dál, dál do zahraničí. A také se mi to právě díky skvělým zkušenostem, které jsem na QPlayi nabral, povedlo a stal jsem se builderem na německém serveru GommeHD. Když se na to zpětně podívám, tak bych nikdy předtím neřekl, že se právě díky QPlayi dostanu takhle daleko. Jsem velmi rád, a moc děkuji Jendovi a celému týmu, že jsem měl tu možnost být součástí tohoto skvělého projektu, poznat tyto skvělé lidi a zažít tolik zábavy. 🫶"
                        imageOnRight={true}
                    />
                    <MemberMemory
                        nick="vadys_"
