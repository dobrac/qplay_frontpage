...
import Dastrokk from "../../public/images/team/Dastrokk.png"
        ...
        <div>
            ...
            <section className="aboutus">
                <div className="container">
                    ...
                    />
                    <MemberMemory
                        nick="Dastrokk (Quality Manager)"
                        image={Dastrokk}
                        text="Na QPlay som nastúpil do Helper Teamu už v prvej polovici roku 2019. Tomu však predchádzalo moje pôsobenie na viacerých menších projektoch, kde som naberal skúsenosti, vďaka ktorým som nabral odvahu sa prihlásiť na nábor práve na QPlay. Za tých takmer 5 rokov pôsobenia som vystriedal mnoho pozícii, vďaka ktorým som získal veľa nových skúseností do života. V roku 2021 som sa popri pozícii Helpera, stal Hlavným CheatHunterom. Následne v roku 2022 som túto pozíciu opustil. V tomto roku mi bola taktiež ponúknutá pozícia vo vedení teamu, a to konkrétne vznikajúceho Moderátor Teamu. Po necelom roku som sa chcel znova posunúť a stal som sa Quality Managerom, túto pozíciu zastávam doteraz. Za všetky tieto skúsenosti získané za 5 rokov pôsobenia na serveri som nesmierne rád, verím, že ich dokážem využiť niekde ďalej. Som aj veľmi rád za poznanie nových skvelých ľudí."
                        imageOnRight={true}
                    />
                </div>
            </section>
