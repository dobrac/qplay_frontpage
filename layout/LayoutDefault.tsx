                ...
                <div className="icons">
                  <a href="https://www.instagram.com/qplaycz/">
                    <div className="icon instagram">
                      ...
                      <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16" className="bi bi-instagram">
                          <path
                  ...
                  <a href="https://www.youtube.com/qplaycz">
                    <div className="icon youtube">
                      ...
                      <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16" className="bi bi-youtube">
                          <path
